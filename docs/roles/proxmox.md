...
Configures a Proxmox VE host itself: repositories, nag removal, backups, SMTP, and host-level tuning. This is separate from `infra.yml`, which provisions VMs and LXCs.
...
# proxmox_defaults.api_user: root@pam
